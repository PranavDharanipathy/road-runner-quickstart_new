...
@TeleOp (name = "OOP_RED_Bot3Driver")
public class OOP_RED_Bot3Driver extends OpMode {
    ...
    private Intake intakeAndSampleModes = new Intake(OurColorSensor.DetectedColor.RED);
