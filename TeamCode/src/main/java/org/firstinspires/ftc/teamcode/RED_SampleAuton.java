...
@Autonomous(name = "RED_Feb_22_SampleAuton", group = "Areas")
public class RED_SampleAuton extends LinearOpMode {
    ...
    private OurColorSensor.DetectedColor ALLIANCE_COLOR = RED;
    private OurColorSensor.DetectedColor OPPOSITE_ALLIANCE_COLOR = BLUE;
    ...
    public void runOpMode() {
        ...
        Action adjustForFifthSample = toFifthSample.endTrajectory().fresh()
                .setTangent(0)
                .splineToLinearHeading(new Pose2d(-4,-4, Math.toRadians(25)), Math.toRadians(0))
                .build();

        Action unAdjustForFifthSample = toFifthSample.endTrajectory().fresh()
                .setTangent(0)
        ...
        if (SUBMERISBLE_TANGENT == 0) {
            ...
            backToBucketForFifthSample = drive.actionBuilder(initialPose)
                    .turnTo(SUBMERISBLE_TANGENT)
                    .setTangent(0)
                    .setReversed(true)
                    .splineTo(new Vector2d(-72, -112), Math.toRadians(-115))
                    .build();
        }
